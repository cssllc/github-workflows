<?php
/**
 * WP Engine prevents writing PHP files as a security precaution.
 *
 * @link https://discourse.roots.io/t/sage-9-on-wpengine/9090/61
 */

$compiled_dir = trailingslashit( wp_upload_dir()['basedir'] ) . 'cache';

if ( defined( 'PWP_NAME' ) ) {
	$compiled_dir = trailingslashit( get_temp_dir() ) . 'sage-cache/' . PWP_NAME;
}
